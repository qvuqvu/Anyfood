...
export const colors = {
  white: "text-light_grey bg-white hover:bg-light_grey",
  ghost:
    "bg-transparent text-dark_primary border-1 border-secondary hover:bg-border_grey",
  secondary: "bg-secondary text-dark_primary hover:bg-border_grey",
  primary: "bg-primary text-white font-pops hover:bg-dark_primary",
  opaque:
    "bg-[rgba(249,249,249,0.15)] hover:bg-[rgba(249,249,249,0.3)] text-white",

  red: "bg-transparent border border-red-500 rounded-lg text-red-500",
};
